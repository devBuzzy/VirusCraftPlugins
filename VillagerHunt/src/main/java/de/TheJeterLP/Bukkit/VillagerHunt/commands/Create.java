...
public class Create extends SubCommand {
    ...
    public CommandResult executePlayer(Player p, CommandArgs args) {
        ...
        VillagerHunt.getMessageManager().message(p, MessageManager.PrefixType.INFO, "Successfully created. Please set the spawns and the sign now. After that you can do /vh finish " + id);
        return CommandResult.SUCCESS;
    }
