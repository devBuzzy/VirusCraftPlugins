 ...
 * @author TheJeterLP
 */
public class Command_Nick extends BaseCommand {

    public Command_Nick() {
        super("nick");
        helpPages.add(new CommandHelp("/nick <name>", "Sets your nickname to <name>"));
    }
    ...
    public CommandResult onPlayerCommand(Player p, Command cmd, CommandArgs args) throws Exception {
        ...
        vcp.setDisplayName(args.getString(0));
        return Utils.sendMessage(MessageType.INFO, p, "Your name was changed to " + vcp.getDisplayName());
    }
