 ...
 * @author TheJeterLP
 */
public class Command_Day extends BaseCommand {
    
    public Command_Day() {
        super("day");
        helpPages.add(new CommandHelp("/day", "Sets the time to day."));
    }
    ...
    public CommandResult onPlayerCommand(Player p, Command cmd, CommandArgs args) throws Exception {
        ...
        return Utils.sendMessage(MessageType.INFO, p, "Time has been set to day.");
    }
