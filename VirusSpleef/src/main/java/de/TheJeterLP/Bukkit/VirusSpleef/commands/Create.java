...
public class Create extends SubCommand {
    ...
    public CommandResult executePlayer(Player p, CommandArgs args) {
        ...
        VirusSpleef.getMessageManager().message(p, MessageManager.PrefixType.INFO, "Successfully created. Please set the spawns and the sign now. After that you can do /spleef finish " + id);
        return CommandResult.SUCCESS;
    }
